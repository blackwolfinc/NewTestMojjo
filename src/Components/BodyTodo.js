...
let date=today.getFullYear()+"-"+  parseInt(today.getMonth()+1) +"-"+today.getDate() + " "+ (Number(h)-1)+":"+i+':'+s;
return date
    ...
    const handleSumbitNewTodo =(e)=>{
        ...
        dataValue.push({id :bigData.length +1, title : ValueTodo , description :ValueDec ,   status : 1, createdAt :handleTimeStamp() })
